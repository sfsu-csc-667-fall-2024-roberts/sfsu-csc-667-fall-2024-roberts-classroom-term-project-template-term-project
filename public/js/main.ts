...
function updateSummary() {
  ...
  const selectedTokenText = document.getElementById('selected-token') as HTMLElement;
  const selectedBotsText = document.getElementById('selected-bots') as HTMLElement;
